...
# Run A* for NYC graph using Manhattan distance
a_star(manhattan_graph, penn_station, grand_central_station, manhattan_heuristic)

# Run A* for India graph using Euclidean distance
a_star(euclidean_graph, jaipur, bengaluru, euclidean_heuristic)